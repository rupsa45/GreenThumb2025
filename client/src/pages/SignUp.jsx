...
const SpriteSignupForm = () => {
  ...
  return (
    <div className="min-h-screen bg-white/50 flex items-center justify-center p-4">
      <div className="flex w-full max-w-5xl bg-white/90 rounded-lg shadow-lg overflow-hidden">
        {/* Quote Section */}
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-green-600 to-lime-500 p-12 flex-col justify-center text-white">
          ...
          <blockquote className="text-2xl font-light mb-4">
            Smart farming isn&apos;t just about growing crops; it&apos;s about
            growing possibilities.
          </blockquote>
          <p className="text-lg opacity-90">
            Make data-driven decisions for your farm&apos;s success with our
...
export default SpriteSignupForm;
